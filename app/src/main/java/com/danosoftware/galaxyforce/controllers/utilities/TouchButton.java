...
/**
 * This provides classes implementing touch buttons with common methods to help check touch button
 * state.
 */
public final class TouchButton {
  ...
  /**
   * check if button has been pressed. returns true if within a button's bounds and finger has
   * touched down
   *
  ...
  /**
   * check if button should be released returns true if finger has been lifted within a button's
   * bounds. this is normally processed as pressed button.
   *
   * @param inButtonBounds - is finger within button bounds
   * @param touchEvent     - touch event type
  ...
  /**
   * check if button should be released as finger has been dragged outside bounds. returns true if
   * finger dragged outside button's bounds. this is normally processed as a released button but NOT
   * a pressed button.
   *
   * @param inButtonBounds - is finger within button bounds
   * @param touchEvent     - touch event type
  ...
  /**
   * check if finger has been dragged significantly. returns true if finger dragged significantly.
   * this is normally processed as a swipe drag and if button had previously been pressed, it will
   * no longer be processed as a pressed button.
   */
  public static boolean isDragged(int touchEvent, Vector2 startTouchPoint,
