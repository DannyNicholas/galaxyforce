...
/**
 * Base Controller Model interface for touch point implementations (e.g. drag and joystick).
 */
public interface TouchBaseControllerModel {
  ...
  /**
   * Updates the current touch point and calculates the base movement's weighting using the current
   * touch point referenced to the centre point.
   *
