...
public class AchievementService {
  ...
  private static final Map<PowerUpType, Integer> powerUpAchievementsMap = new EnumMap<>(
      PowerUpType.class);
  ...
  private static final Map<AlienCharacter, Integer> aliensAchievementsMap = new EnumMap<>(
      AlienCharacter.class);
   ...
   * <p>
   * Achievements may be generated for completing specific waves and for completing waves with no
   * lives lost.
   */
   ...
   * <p>
   * Power-up collected won't trigger any achievements until either the wave is completed or game
   * over.
   */
   ...
   * <p>
   * Aliens destroyed won't trigger any achievements until either the wave is completed or game
   * over.
   */
  ...
  /**
   * Unlock achievement. If unlock fails, store in a list to allow re-try later.
   */
  ...
  /**
   * Unlock all pending achievements from list. Remove from list if successful.
   */
