 ...
 * <p>
 * Jackson annotations ensure the correct concrete implementation is constructed on
 * deserialization.
 * <p>
 * e.g. if the JSON path holds... "type": "bezier" ...then a Bezier path DTO is constructed using
 * the other JSON fields.
 */
