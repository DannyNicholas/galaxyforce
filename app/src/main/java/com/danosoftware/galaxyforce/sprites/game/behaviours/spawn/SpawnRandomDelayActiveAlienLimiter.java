 ...
 * maximum number of aliens are still active, no more can be spawned.
 * <p>
 * This is different from SpawnRandomDelayLimiter in that it checks any active alien, not just those
 * spawned by this spawner.
 */
