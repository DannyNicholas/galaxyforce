...
public class AlienMissileFactory {
  ...
  /**
   * Return a list of missiles based on the type. Missile initial position will be based on the
   * base's position. Direction will be used to determine initial position and direction of travel.
   */
