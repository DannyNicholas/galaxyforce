...
/**
 * Missile Fire Behaviour that fires on fixed cycles set by the frequency (time in seconds between
 * firing).
 * <p>
 * However, each instance randomises it's start time to avoid all aliens firing their missiles at
