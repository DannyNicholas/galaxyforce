...
public class AlienStork extends SpriteAlienWithPath
{
    /*
     * ******************************************************
    ...
    // alien animation
    private static final Animation ANIMATION = new Animation(0.4f, GameSpriteIdentifier.STORK_1, GameSpriteIdentifier.STORK_2);
