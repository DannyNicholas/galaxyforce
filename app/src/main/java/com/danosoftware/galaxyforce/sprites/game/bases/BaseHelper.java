 ...
 * <p>
 * A Base Helper can - fire missiles - collect power-ups - can be shielded - be destroyed by a
 * missile or alien
 * <p>
 * If the primary base is destroyed, all helper bases will also be destroyed
 * <p>
 * A helper base can have two states:
 * <p>
 * ACTIVE - normal state EXPLODING - base can no longer move, fire, collect power-ups, collide with
 * missiles/aliens or gain shields
 * <p>
...
public class BaseHelper extends AbstractCollidingSprite implements IBaseHelper {
   ...
   * <p>
   * - Creates new helper - Registers helper with primary base
   */
  ...
  /**
   * private BaseHelper constructor. Use static helper creator to ensure helper base is registered
   * with primary base.
   */
  private BaseHelper(
      final IBasePrimary primaryBase,
