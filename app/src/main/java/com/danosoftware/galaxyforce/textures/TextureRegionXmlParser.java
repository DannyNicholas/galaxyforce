...
/**
 * Responsible for loading xml texture property files and returning a list of texture properties as
 * TextureDetails.
 * <p>
...
public class TextureRegionXmlParser {
  ...
  private List<TextureDetail> readTextureFile(XmlPullParser parser)
  ...
  private TextureDetail readTextureRegion(XmlPullParser parser)
      throws XmlPullParserException, IOException {
