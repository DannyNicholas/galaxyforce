...
public class GamePlayHandlerRefactor implements GameHandlerRefactor
{
...
//    private List<DirectionListener> directionListeners;
    ...
    private IBasePrimarySprite primaryBase = null;
...
//    private EnergyBar energyBar = null;
    ...
    public GamePlayHandlerRefactor(GameModel model, ControllerBase controller, List<Star> stars, int wave, IBillingService billingService)
    {
...
//        changingDirection = false;
     ...
     */
    private List<ISprite> buildSpriteList()
    {
        List <ISprite> sprites = new ArrayList<>();

        sprites.addAll(stars);
        sprites.addAll(aliens);
        sprites.addAll(bases);
//        allSprites.addAll(shields);
        sprites.addAll(aliensMissiles);
        sprites.addAll(baseMissiles);
        sprites.addAll(powerUps);
//        allSprites.addAll(hits);
        sprites.add(pauseButton.getSprite());
//        allSprites.add(flipButton.getSprite());
        sprites.addAll(flags);
        sprites.addAll(lifeSprites);
//        allSprites.addAll(energy);
        sprites.addAll(baseController.getSprites());
