...
public class IntroductoryPathConfigTest {
  ...
  @Test
  public void shouldCreateBasicConfiguredIntroductoryPathAlien() {
    ...
    assertThat(aliens.get(0) instanceof IntroductoryPathAlien, is(true));
  }
