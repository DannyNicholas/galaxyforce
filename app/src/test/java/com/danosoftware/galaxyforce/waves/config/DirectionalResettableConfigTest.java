...
public class DirectionalResettableConfigTest {
  ...
  public void shouldCreateBasicConfiguredDirectional() {
    DirectionalResettableConfig config = DirectionalResettableConfig
        .builder()
    ...
    assertThat(config.getAlienType(), equalTo(AlienType.DIRECTIONAL_RESETTABLE));
    ...
    assertThat(aliens.get(0) instanceof DirectionalResettableAlien, is(true));
  }
