...
public class BaseHelperTest {
  ...
  @Test()
  public void unshieldedBaseShouldExplodeWhenHitByMissile()
  ...
  @Test()
  public void shieldedBaseShouldNotExplodeWhenHitByMissile()
      throws NoSuchFieldException, IllegalAccessException {
    baseHelper = shieldedHelper(LEFT);
    baseHelper.onHitBy(mock(IAlienMissile.class));
  ...
  @Test()
  public void unshieldedBaseShouldExplodeWhenHitByAlien()
      throws NoSuchFieldException, IllegalAccessException {
    baseHelper = unShieldedHelper(LEFT);
  ...
  @Test()
  public void shieldedBaseShouldNotExplodeWhenHitByAlien()
      throws NoSuchFieldException, IllegalAccessException {
    baseHelper = shieldedHelper(LEFT);
    baseHelper.onHitBy(mock(IAlien.class));
    assertThat(helperState(baseHelper), is(ACTIVE));
  ...
  private BaseState helperState(IBaseHelper baseHelper)
      throws NoSuchFieldException, IllegalAccessException {
