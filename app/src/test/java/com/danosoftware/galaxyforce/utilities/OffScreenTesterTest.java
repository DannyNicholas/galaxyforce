 ...
 * screen.
 * <p>
 * Test moves sprites to position just off and just on screen and checks the off-screen tester
 * returns the expected responses.
 * <p>
 * Test uses a mocked 10 x 10 sprite.
 * <p>
 * A 10x10 sprite is off-screen when x or y is 5 pixels from edge since we measure position from
 * centre of sprite.
 */
